package com.jzo2o.thirdparty.tencent;
...
import com.jzo2o.thirdparty.tencent.properties.BuWeChatProperties;
import com.jzo2o.thirdparty.tencent.properties.WechatProperties;
import com.jzo2o.thirdparty.tencent.properties.YeWeChatProperties;
...
public class WechatServiceImpl implements WechatService {
    ...
    public String getOpenid(String code, String type) {
        Map<String, Object> requestUrlParam = getAppConfig(type);
        // 小程序端授权后的code 登录临时凭证
     ...
     */
    @Override
    public String getPhone(String code, String type) {
        // 获取服务端调用凭证 token
     ...
     * @return 参数集合
     */
    private Map<String, Object> getAppConfig(String type) {
        Map<String, Object> requestUrlParam = new HashMap<>();
        if ("ye".equals(type)) {
            requestUrlParam.put("appid", YeWeChatProperties.APP_ID);
            requestUrlParam.put("secret", YeWeChatProperties.APP_SECRET);
        } else if ("bu".equals(type)) {
            requestUrlParam.put("appid", BuWeChatProperties.APP_ID);
            requestUrlParam.put("secret", BuWeChatProperties.APP_SECRET);
        } else {
            // 小程序appId，开发者后台获取
