...
public class InnerWechatController implements WechatApi {
    ...
    public OpenIdResDTO getOpenId(@RequestParam("code") String code, @RequestParam("type")String type) {
        String openId = wechatService.getOpenid(code, type);
    ...
    public PhoneResDTO getPhone(@RequestParam("code") String code, String type) {
        String phone = wechatService.getPhone(code, type);
