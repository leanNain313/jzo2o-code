...
public interface WechatApi {
    ...
    OpenIdResDTO getOpenId(@RequestParam("code") String code, @RequestParam("type")String type);

    @GetMapping("/getPhone")
    PhoneResDTO getPhone(@RequestParam("code") String code,  @RequestParam("type")String type);
}
